...
import { adminUpdateNews, adminListNewsCategories, adminListNews } from "@/lib/services/admin-content.functions";
...
function EditNewsPage() {
  ...
  const newsItem = newsData.news.find((n: any) => n.id === newsId);
  ...
  return (
    <div className="grid gap-6 max-w-5xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="font-pixel text-xl uppercase text-foreground">Editar Notícia</h2>
          <p className="text-sm text-muted-foreground">Modificando: {newsItem.title}</p>
        </div>
      </div>
