...
import { adminCreateCategory } from "@/lib/services/admin.functions";
...
export const Route = createFileRoute("/admin/categorias/new")({
...
function NewCategoryPage() {
  ...
  const mutation = useMutation({
    mutationFn: (values: CategoryFormValues) => adminCreateCategory({ data: values }),
    onSuccess: () => {
  ...
  return (
    <div className="grid gap-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="font-pixel text-xl uppercase text-foreground">Nova Categoria</h2>
          <p className="text-sm text-muted-foreground">Crie uma nova seção para os produtos da loja.</p>
        </div>
      </div>
