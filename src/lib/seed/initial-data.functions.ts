...
export const runDatabaseSeed = createServerFn({ method: "POST" })
  ...
  .handler(async ({ context }) => {
    ...
    // --- MODOS DO SERVIDOR ---
    const modes = [
      { slug: "survival", name: "Survival", description: "Economia, missões, clãs e proteção de terreno.", active: true, position: 1 },
      { slug: "skyblock", name: "SkyBlock", description: "Comece numa ilha flutuante e expanda seu império.", active: false, position: 2 },
      { slug: "rankup", name: "RankUP", description: "Minere, evolua de rank e desbloqueie novas áreas.", active: false, position: 3 },
      { slug: "minigames", name: "Minigames", description: "Partidas rápidas e arenas competitivas.", active: false, position: 4 },
    ];
    ...
    const status = {
      ...
      players_max: 500,
      version: "1.21+",
      ip_address: "jogar.habbletmine.com.br"
    };
    ...
    const rankings = [
      { category: "ricos", player_name: "Demo_Player1", score: 1000000, position: 1, period: "weekly" },
      { category: "ricos", player_name: "Demo_Player2", score: 500000, position: 2, period: "weekly" },
      { category: "abates", player_name: "Demo_Warrior", score: 150, position: 1, period: "weekly" },
    ];
    // Limpar rankings demo antes de inserir
