...
values 
('termos', 'Termos de Compra e Uso', '<h2>1. Aceitação</h2><p>Ao utilizar este portal e realizar compras, você concorda com estes termos.</p><h2>2. Itens Digitais</h2><p>As compras consistem em itens digitais para uso exclusivo no servidor Avance.</p><h2>3. Prazos</h2><p>A entrega é automática mas pode levar até 1 hora em casos de instabilidade.</p>', 1),
